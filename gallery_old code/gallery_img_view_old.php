                ...
                <section id="about" class="ls section_padding_top_110 columns_padding_30">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">       
                                <?php
                                $sqlre = "select `id`,`title`,`date`,`description`,`image`,`cby`,`cdate`,`cip`,`mby`,`mdate`,`mip`from `vdca_gallery`  where id=$id ORDER BY id DESC ";
                                $resulte = mysqli_query($mysqli, $sqlre);
                                while ($rowe = mysqli_fetch_array($resulte)) {
                                    ...
                                    <center><h3>
                                            <ol class="breadcrumb greylinks">
                                                <li> <a href="gallery_old.php"> Gallery</a> </li>
                                                <li class="active" style="color: #f3702b"><?php
                                                    echo $title;
                                                }
                                                ?></li>
                                        </ol>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <?php foreach ($image as $key) { ?>
                                            <div class="gallery-card">
                                                <a href="admin/master/<?php echo $key; ?>" class="color-2 rest" data-lcl-txt="<?php $name2 = pathinfo($key, PATHINFO_FILENAME);
                                    $imagename = str_replace("gallery/[", "", "$name2");
                                    $imagename2 = preg_replace('/[^A-Za-z\-]/', '', $imagename);
                                    echo $imagename2; ?>"  data-lcl-thumb="admin/master/<?php echo $key; ?>">
                                                    <img src="admin/master/<?php echo $key; ?>"alt="gallery" style="width: 100%;height: 170px;">
                                                    <span class="hide-desc h5">View</span> 
                                                    <p style="font-size: 14px;word-break: break-word; word-spacing: 3px;letter-spacing: 1.1px;text-align: justify; margin-left: 4px;color: #cd3232;"><?php $name2 = pathinfo($key, PATHINFO_FILENAME);
                                    $imagename = str_replace("gallery/[", "", "$name2");
                                    $imagename2 = preg_replace('/[^A-Za-z\-]/', ' ', $imagename);
                                    echo $imagename2; ?></p>
